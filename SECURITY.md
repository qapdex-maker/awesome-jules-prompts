...
1. <span aria-hidden="true">🛑</span> **Do not** open a public issue.
2. <span aria-hidden="true">✉️</span> Contact the maintainers privately (e.g., via the contact information provided in the <a href="https://github.com/qapdex-maker" target="_blank" rel="noopener noreferrer" aria-label="repository profile (opens in a new tab)">repository profile</a>).
3. <span aria-hidden="true">📝</span> Provide a detailed description of the vulnerability and steps to reproduce it.
