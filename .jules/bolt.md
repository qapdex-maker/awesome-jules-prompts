...
**Action:** Always audit pre-filtering pipelines for fallback/always-scan rules. Design high-selectivity custom bytes pre-filters for unstructured patterns, and execute all pre-filtering on raw bytes prior to file content decoding.
