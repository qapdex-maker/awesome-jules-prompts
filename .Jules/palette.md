...
## 2026-07-09 - [Cross-Document Visual Consistency]

**Learning:** Using consistent visual identifiers (like emojis) across headings
in the main README and their corresponding sub-documents (e.g., contributing.md,
SECURITY.md) reinforces the user's mental model and provides a more cohesive
experience.
**Action:** When updating sectional navigation or sub-documents, ensure that
headings and links share consistent iconography and formatting.
=======
